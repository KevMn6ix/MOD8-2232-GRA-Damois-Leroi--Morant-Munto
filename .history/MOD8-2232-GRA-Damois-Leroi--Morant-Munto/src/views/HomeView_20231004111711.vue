...
<template>
  ...
  <main id="home-body">
    ...
    <RouterLink :to="{name : 'PlacesList', params : {types: 'restaurants'}}">
    ...
    <RouterLink :to="{name : 'PlacesList', params : {types: 'activities'}}">
      <RowLandingPage textId="travel" textTitle="Travel"/>
    </RouterLink>

    <RouterLink :to="{name : 'PlacesList', params : {types: 'travel'}}">
