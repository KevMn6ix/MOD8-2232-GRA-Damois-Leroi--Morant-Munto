...
function sendUserInput() {
    ...
    axios.post("http://localhost:8081/places/add", {name: UserInput.value.Title, address: UserInput.value.Address, photoUrl: UserInput.value.Picture, type: UserInput.value.Type}).then(responce => {
